...
class AssignController extends BaseController
{
    ...
    { 
        $this->folder = 'assigning/';
        $this->Controller = 'ScheduleController';
        $this->url = 'admin/assigning';
        $this->MainTitle = "Assigning";
        $this->id = "schedule_id";
    ...
    function add( $edit_id = '' )
    {
        ...
        $ScheduleModel = new ScheduleModel();;
        $data['schedule_items'] = $ScheduleModel->where('status',1)->where('isDelete',0)->orderBy('schedule_time','ASC')->findAll();
        
        // $Users_Model = new Users_Model();;
        // $data['users'] = $Users_Model->where('status',1)->where('isDelete',0)->where('user_id !=', 1) ->findAll();
        ...
        $query->where('ur.role_pid',2);
        $query->orwhere('ur.role_pid',3);
        $user_data = $query->get()->getResultArray();
