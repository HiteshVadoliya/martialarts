...
$segment = $uri->getTotalSegments() >= 2 && $uri->getSegment(2) ? $uri->getSegment(2) : "";
$action = $uri->getTotalSegments() >= 3 && $uri->getSegment(3) ? $uri->getSegment(3) : "";

?>
<!-- Brand Logo -->
    <a href="<?php echo base_url('admin/dashboard');?>" class="brand-link">
        <img src="<?php echo base_url();?>public/uploads/logo.png" alt="<?= constant('APP_NAME') ?>" class="brand-image img-circle elevation-3" style="opacity: .8">
