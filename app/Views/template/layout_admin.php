...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="<?php echo base_url();?>public/uploads/logo.png">
  ...
  <script src="<?php echo base_url();?>public/custom.css"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.20.0/jquery.validate.min.js"></script>
  
  <script src="<?php echo base_url();?>public/bootstrap-notify.js"></script>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <?php echo $this->include('template/admin_sidebar'); ?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?= date('Y') ?> <a href="<?= base_url(); ?>"><?= constant('APP_NAME') ?></a>.</strong>
    All rights reserved.
