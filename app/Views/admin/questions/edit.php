          ...
          <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-1">
                    ...
                    <textarea name="note" id="note" cols="30" rows="5" class="form-control"><?= $data['Notes'] ?></textarea>
                </div>

                <div class="col-md-12 mb-1 ">
                    <label for="" class="campaign">Campaign <span class="text-danger">*</span></label> <br>
                    <?php foreach ($campaigns as $campaign) { ?>
                        <input type="checkbox" name="campaign[]" value="<?= $campaign->Camp_id ?>" id="campaign-<?= $campaign->Camp_id ?>" <?= $campaign->Selected ? "checked" : "" ?>> <?= $campaign->Camp_Name ?> <br>
                    <?php } ?>
                </div>
                <div class="col-md-12">
